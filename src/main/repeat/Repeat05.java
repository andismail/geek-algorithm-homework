...
public class Repeat05 {
    ...
    private void f_94(TreeNode root, List<Integer> res) {
        if (root == null) {
            return;
        }
        f_94(root.left, res);
    ...
    private void f_144(TreeNode root, List<Integer> res) {
        if (root == null) {
            return;
        }
        res.add(root.val);
        f_144(root.left, res);
        f_144(root.right, res);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(r.serialize1(root));
    }
    ...
    public TreeNode buildTree(int[] preorder, int[] inorder) {
        ...
        return f_b(linkedList);
    }

    private TreeNode f_b(List<Integer> list) {
    ...
    public double _50(int x, int n) {
        double y = f_50(x, n > 0 ? n : -n);

        return n > 0 ? y : 1 / y;
    }

    public double f_50(int x, int n) {
        if (x == 0) {
            return 0;
        }
        if (n == 0) {
     ...
     * 74.搜索二维矩阵
     */
    public boolean _74(int[][] matrix, int target) {
